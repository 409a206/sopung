...
public class MoveToHometown extends JFrame{
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MoveToHometown frame = new MoveToHometown();
	...
	public MoveToHometown() {
		...
		String[] busChat = {"마을로 돌아가시겠습니까?","(Y/N)\r\n"};
		...
		backGround.setIcon(new ImageIcon(InPharmacy.class.getResource("/textures/cityToHometown.png")));
