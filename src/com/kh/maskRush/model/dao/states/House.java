...
public class House extends JPanel {
	...
	public House(FirstMenuChoice mainChoice) {
				...
				if (e.getKeyCode() == KeyEvent.VK_SPACE) {
					...
					click.addMouseListener(new MouseAdapter() {
						public void mouseClicked(MouseEvent e) {
							ChangePanel.changePanel(mainChoice, panel, new HomegroundMonologue(mainChoice));
						}
					});
				}
			}
		...
		talk.setIcon(new ImageIcon(House.class.getResource("/textures/대화창2.png")));
		talk.setBounds(-15, -15, 800, 600);
		this.add(talk);

		// 배경라벨
		JLabel back = new JLabel();
		// boy.setLabelFor(back);
		back.setIcon(new ImageIcon(House.class.getResource("/textures/living3.png")));
