...
public class InCity1 extends JPanel {
	...
	//기본패널설정
	public InCity1 (FirstMenuChoice mainChoice) {
...
//		mainChoice.getContentPane().add(this);
		...
		//도시배경
				...
				background.setIcon(new ImageIcon(FirstMenu.class.getResource("/textures/city/city1.png")));
	...
	public void boy () {
		...
		character.setBounds(40, 230, 100, 100);	//캐릭터 위치 크기 설정
	...
	class MyKeyListener extends KeyAdapter {
		public void keyPressed(KeyEvent e) {
			...
			if(character.getX() <= 0 ) {
				...
				ChangePanel.changePanel(mainChoice, contentPane, new InCity2(mainChoice));
			}
		}
	}
