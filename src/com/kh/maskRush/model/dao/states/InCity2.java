...
public class InCity2 extends JPanel {
	...
	//기본패널설정
	public InCity2 (FirstMenuChoice mainChoice) {
...
//		mainChoice.getContentPane().add(this);
		//도시배경
				...
				background.setIcon(new ImageIcon(FirstMenu.class.getResource("/textures/city/city2.png")));
	...
	public void boy () {
		...
		character.setBounds(400, 200, 100, 100);	//캐릭터 위치 크기 설정
...
//			if(character.getX() <= 0 ) {
//				
//				ChangePanel.changePanel(mainChoice, contentPane, new InCity1(mainChoice));
//			}
