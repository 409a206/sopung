...
public class InCity4 extends JPanel {
	...
	//기본패널설정
	public InCity4 (FirstMenuChoice mainChoice) {
...
//		mainChoice.getContentPane().add(this);
		...
		background.setIcon(new ImageIcon(FirstMenu.class.getResource("/textures/city/city4.png")));
