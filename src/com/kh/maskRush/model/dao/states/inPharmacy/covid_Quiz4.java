...
public class covid_Quiz4 extends JPanel {
	...
	public covid_Quiz4(Menu frame) {
		...
		charBoy.setIcon(new ImageIcon(covid_Quiz4.class.getResource("boy_moving_ff.gif")));
		charBoy.setBounds(305,350,150,150);
		this.add(charBoy);
		
		//배경라벨
		JLabel background = new JLabel();
		background.setIcon(new ImageIcon(covid_Quiz4.class.getResource("q4.png")));
		...
		right.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
					...
					changePanel.changePanel(mainChoice, contentPane, new explain_4(mainChoice));
		...
		wrong.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
					...
					changePanel.changePanel(mainChoice, contentPane, new wrAn4(mainChoice));
