...
public class Room extends JPanel {
	...
	public Room(FirstMenuChoice mainChoice, Player a) {
			...
			public void keyPressed(KeyEvent e) {
				...
				if (keyCode == KeyEvent.VK_LEFT) {
					if (boyPanel.getY() <= 432 && boyPanel.getY() >= 368) {
						ChangePanel.changePanel(mainChoice, panel, new House(mainChoice, a));
					}
				}
		...
		boyPanel.setBounds(173, 229, 90, 100);
		add(boyPanel);
		...
		back.setIcon(new ImageIcon(Room.class.getResource("/InConvenience/bedroomMonoC.png")));
		back.setBounds(-16, -15, 800, 600);
		this.add(back);
