...
public class InConvenienceStore_talk extends JPanel {
   ...
   public InConvenienceStore_talk(FirstMenuChoice mainChoice) {
      ...
      cu.setIcon(new ImageIcon(InConvenienceStore_talk.class.getResource("알바생.png")));
      ...
      talk.setIcon(new ImageIcon(InConvenienceStore_talk.class.getResource("대화창.png")));
