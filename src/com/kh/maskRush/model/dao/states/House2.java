...
public class House2 extends JPanel {
	...
	public House2(FirstMenuChoice mainChoice, Player a) {
		...
		talk.setIcon(new ImageIcon(House2.class.getResource("/textures/대화창.png")));
		...
		back.setIcon(new ImageIcon(House2.class.getResource("/textures/living3.png")));
