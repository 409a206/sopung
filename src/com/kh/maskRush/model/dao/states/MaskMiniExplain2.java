...
public class MaskMiniExplain2 extends JFrame {
   ...
   public static void main(String[] args) {
      ...
      EventQueue.invokeLater(new Runnable() {
         public void run() {
            try {
               MaskMiniExplain2 frame = new MaskMiniExplain2();
...
//      this.add(talk);
      ...
      backGround.setIcon(new ImageIcon(InPharmacy.class.getResource("/textures/maskMiniExplain2.png")));
